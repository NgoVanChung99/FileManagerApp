...
import com.nvchung.filemanager_ftp_da3.grid_utils.GridAdapter;
import com.nvchung.filemanager_ftp_da3.list_utils.MyRecyclerAdapter;
import com.nvchung.filemanager_ftp_da3.serverftp.gui.AboutActivity;
import com.nvchung.filemanager_ftp_da3.serverftp.gui.MainActivityFTP;
import com.nvchung.filemanager_ftp_da3.serverftp.gui.ManageUsersActivity;
import com.nvchung.filemanager_ftp_da3.serverftp.locale.EditActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.ServerFTP) {

//------------FTP server-----------------------------
                    startActivity(new Intent(MainActivity.this, MainActivityFTP.class));
