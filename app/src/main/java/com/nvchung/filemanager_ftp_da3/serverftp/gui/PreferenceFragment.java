...
//import com.nvchung.filemanager_ftp_da3.android.DynamicMultiSelectListPreference;
...
public class PreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        marketVersionPref.setOnPreferenceClickListener(preference -> {
            ...
            intent.setData(Uri.parse("market://details?id=com.nvchung.filemanager_ftp_da3.serverftp"));
...
//                App.AutoConnect.maybeStartService(App.getAppContext());
//                break;
            case "" :
                break;
        }
